...
class Game:
    ...
    def __init__(self):
        ...
        self.assets = {
            ...
            'slashRight':pygame.transform.scale(loadImage('slashAttack/slashRight.png'), (16,20)),
            'slashLeft':pygame.transform.scale(loadImage('slashAttack/slashLeft.png'), (16,20))
        }
